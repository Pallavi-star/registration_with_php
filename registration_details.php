<?php
    ...
    if(isset($_POST['save'])){   
        ...
        $query="INSERT INTO register_tbl(user_name,email_id,password,cnfrm_pass,first_name,last_name,dob,gender,address,country,status,ph_no,skill,one_word,hobby,describe_self) VALUES('$user_name','$email_id','$password','$cnfrm_pass','$first_name','$last_name','$dob','$gender','$address','$country','$status','$ph_no','$skill','$one_word','$hobby','$describe_self')";
